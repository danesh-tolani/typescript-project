    ...
    <section id={`${SelectedPage.ContactUs}`} className="mx-auto w-5/6 pt-24 pb-32">
        ...
        >
            ...
            >
                ...
                <p className="my-5">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores nisi aperiam illum suscipit temporibus quae placeat velit odit, magni sapiente voluptas illo, quisquam, voluptates ex alias eius quam voluptatibus sint.
                </p>
            </motion.div>
            ...
            <div className="mt-10 justify-between gap-8 md:flex">
                ...
                >
                    <form 
                        ...
                        onSubmit={onSubmit}
                        method="POST"
                        action="https://formsubmit.co/el/towidi"
                    >
                        <input 
                            type="text" 
